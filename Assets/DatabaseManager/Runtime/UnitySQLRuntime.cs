...
namespace DatabaseManager.Runtime
{
    public class UnitySqlRuntime : MonoBehaviour
    {
        ...
        private string databaseFilePath = 
            "Assets/DatabaseManager/Connections/data.sqlite";

        [Header("Tabs")]
        [SerializeField]
        private List<ButtonPanelPair> tabs = new();
        ...
        [SerializeField]
        private GridDrawerUI overviewGridDrawerUI;
    
        [SerializeField]
        private SQLQueryExecutorUI sqlQueryExecutorUI;
    
        [SerializeField]
        private SubmitModalUI submitModalUI;
    
        [SerializeField]
        private AddRowModalUI addRowModalUI;
    
        [SerializeField]
        private Transform connectionsLayoutGroup;
    
        [SerializeField]
        private Transform connectionItemTemplate;
